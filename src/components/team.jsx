  ...
  return (
    <div id="team" className="text-center">
      <div className="container">
        ...
        <div id="row" className="team-container">
          {props.data
            ? props.data.map((d, i) => (
                <div key={`${d.name}-${i}`} className="col-md-3 col-sm-4 team">
                  <div className="card">
                    ...
                    <div className="card-socials">
                      <button onClick={() =>window.open(d.face, '_blank')} className="card-socials-btn facebook">
                        <svg
                          data-name="Layer 21"
                          height="24"
                          id="Layer_21"
                      ...
                      <button onClick={() =>window.open(d.github, '_blank')} className="card-socials-btn github">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="33"
                          height="33"
                      ...
                      <button onClick={() =>window.open(d.linkedin, '_blank')} className="card-socials-btn linkedin">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="512"
                          viewBox="0 0 512 512"
